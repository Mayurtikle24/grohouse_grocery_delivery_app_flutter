...
class FreshFruitesListViewWidget extends StatefulWidget {
  const FreshFruitesListViewWidget({Key? key}) : super(key: key);

  @override
  State<FreshFruitesListViewWidget> createState() =>
      _FreshFruitesListViewWidgetState();
}

class _FreshFruitesListViewWidgetState
    extends State<FreshFruitesListViewWidget> {
    ...
    return Column(
      children: [
              ...
              TextButton(
                onPressed: () {
                  Navigator.of(context)
                    ...
                    return SearchPage(
                        searchList: _productProvider.getFreshFruitsList);
                  }));
                },
                child: Text(
                  "Explore All",
        ...
        SingleChildScrollView(
          ...
          child: Row(
            children: _productProvider.getFreshFruitsList.map((product) {
