...
class PersonalCareListViewWidget extends StatefulWidget {
  const PersonalCareListViewWidget({Key? key}) : super(key: key);

  @override
  State<PersonalCareListViewWidget> createState() =>
      _PersonalCareListViewWidgetState();
}

class _PersonalCareListViewWidgetState
    extends State<PersonalCareListViewWidget> {
    ...
    return Column(
      children: [
              ...
              TextButton(
                onPressed: () {
                  Navigator.of(context)
                    ...
                    return SearchPage(
                        searchList: _productProvider.personalCareList);
                  }));
                },
                child: Text(
                  "Explore All",
        ...
        SingleChildScrollView(
          ...
          child: Row(
            children: _productProvider.getPersonalCareList.map((product) {
