...
class SnacksAndBeveragesListViewWidget extends StatefulWidget {
  const SnacksAndBeveragesListViewWidget({Key? key}) : super(key: key);

  @override
  State<SnacksAndBeveragesListViewWidget> createState() =>
      _SnacksAndBeveragesListViewWidgetState();
}

class _SnacksAndBeveragesListViewWidgetState
    extends State<SnacksAndBeveragesListViewWidget> {
    ...
    return Column(
      children: [
              ...
              TextButton(
                onPressed: () {
                  Navigator.of(context)
                    ...
                    return SearchPage(
                        searchList: _productProvider.getSnacksAndBeveragesList);
                  }));
                },
                child: Text(
                  "Explore All",
        ...
        SingleChildScrollView(
          ...
          child: Row(
            children: _productProvider.getSnacksAndBeveragesList.map((product) {
