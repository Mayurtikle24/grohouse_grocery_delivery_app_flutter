...
class AttaAndGrainsListViewWidget extends StatefulWidget {
  const AttaAndGrainsListViewWidget({Key? key}) : super(key: key);

  @override
  State<AttaAndGrainsListViewWidget> createState() =>
      _AttaAndGrainsListViewWidgetState();
}

class _AttaAndGrainsListViewWidgetState
    extends State<AttaAndGrainsListViewWidget> {
    ...
    return Column(
      children: [
              ...
              TextButton(
                onPressed: () {
                  Navigator.of(context)
                    ...
                    return SearchPage(
                        searchList: _productProvider.getAttaAndGrainsList);
                  }));
                },
                child: Text(
                  "Explore All",
        ...
        SingleChildScrollView(
          ...
          child: Row(
            children: _productProvider.getAttaAndGrainsList.map((product) {
